...
export const UserTimesheetList  = (props) => (
    <List title="Utenti"  {...props}   filters={UserFilter} pagination={<PostPagination />} perPage={9} sort={{ field: 'starttimestamp', order: 'DESC' }}>
    <Datagrid rowClick="edit">
      ...
      <DateField source="starttimestamp" label='Entrata' sortable={false} showTime/>
      <DateField source="stoptimestamp" label='Uscita' sortable={false} showTime/>
      <EditButton/>
     </Datagrid>
